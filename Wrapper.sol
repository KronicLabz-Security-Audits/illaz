...
contract Wrapper is ERC721, IERC721Receiver, Pausable, Ownable {
    ...
    string public defaulturi =
        "ipfs://bafybeidtya3cva6ipizbilbjr6u5obbte452cqbu3odhyya7nxo7feootu/"; //Default URI
    ...
    constructor() ERC721("Illaz", "ILLAZ") {
        punkIllaz = IERC721(ruggedproject);
    ...
    function _baseURI() internal pure override returns (string memory) {
        ...
        return
            "ipfs://bafybeidtya3cva6ipizbilbjr6u5obbte452cqbu3odhyya7nxo7feootu/";
    }
    ...
    function wrap(uint256[] calldata tokenIds_) external {
        ...
        for (uint256 i = 0; i < templength; i++) {
            ...
            punkIllaz.safeTransferFrom(msg.sender, address(this), tokenIds_[i]);
        }
    ...
    function _flip(
        ...
        if (isWrapping_) {
            ...
            punkIllaz.safeTransferFrom(address(this), who_, tokenId_);
    ...
    function emergencyMintWrapped(uint256 tokenId_) external onlyOwner {
        if (punkIllaz.ownerOf(tokenId_) == address(this)) {
